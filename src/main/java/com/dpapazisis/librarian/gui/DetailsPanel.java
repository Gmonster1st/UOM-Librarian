...
//            var parent = (MainWindow) getRootPane().getParent().getParent();
//            var model = (PublisherTableModel) parent.myTable.getModel();
//            if (model.removeItem(publisher)) {
//                model.fireTableDataChanged();
//            }
//            DetailsWindow.this.dispose();
//        });
    }
}
